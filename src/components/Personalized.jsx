    ...
    return (
        <section className='flex flex-col gap-16 mt-16'>
            <div className='w-11/12 mx-auto flex justify-between items-center gap-4'>
                <div className='flex flex-col gap-y-5 w-5/12 p-4 '>
                    <motion.div
                        initial={{opacity:0,
                            scale:0
                        }}
                        whileInView={{opacity:1,
                                scale: 1}}
                        transition={{duration:2}}  className='text-5xl leading-snug p-2'>
                        YOUR PERSONALIZED <span className='gradient font-semibold'>FITNESS HUB</span>
                    </motion.div>
                    <div className='text-lg flex flex-col gap-5 p-1 text-slate-300'>
                        <p>
                ...
                <div className='w-5/12 mt-5 p-1 transition-all duration-100'>
                    <img 
                        key={animationKey} 
                        src={bgImage} 
                        alt="image" 
                        className='w-[37rem] h-[25rem] rounded-md shadow-lg shadow-slate-800 slide-top opacity-90'
                    />
                </div>
            </div>
        </section>
