  ...
  return (
    <section className="flex flex-col items-center w-full px-4">
      <motion.div
        ...
        className="w-full sm:w-3/5 mx-auto text-center"
      >
        <h2 className="text-3xl sm:text-4xl leading-normal p-2 font-semibold">
      ...
      <motion.div
        ...
        transition={{ duration: 2 }}
        className="relative flex flex-col md:flex-row items-center justify-center w-full mt-8 gap-8"
      >
        {/* Previous Button */}
        <button
          onClick={goToPrev}
          className="absolute left-2 sm:left-0 bg-black text-white rounded-full p-1 hover:text-slate-300 transition-all duration-200"
        >
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-6 w-full">
          {/* Data Table */}
          <div className="w-full sm:w-1/2 mx-auto rounded-lg shadow-lg p-4 sm:p-6">
            <div className="flex gap-4 py-4 sm:py-10">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="text-lg md:text-xl font-semibold">
              ...
              <tbody>
                <tr>
                  <td className="p-4 text-lg md:text-xl text-slate-400">
                    Weight
                  </td>
                  <td className="p-4 text-xl sm:text-2xl">
                    {currentPerson.wb} kg
                  </td>
                  <td className="p-4 text-xl sm:text-2xl">
                    {currentPerson.wa} kg
                ...
                <tr>
                  <td className="p-4 text-lg sm:text-xl text-slate-400">
                    Body Fat (%)
                  </td>
                  <td className="p-4 text-xl sm:text-2xl">
                    {currentPerson.bfb}%
          ...
          <div className="w-full sm:w-1/2 flex justify-center items-center">
            <img
              ...
              className="w-full sm:w-[52rem] h-auto object-cover rounded-xl shadow-md"
            />
          </div>
        </div>
        ...
        <button
          onClick={goToNext}
          className="absolute right-2 sm:right-0 bg-black text-white rounded-full p-1 hover:text-slate-300 transition-all duration-200"
        >
